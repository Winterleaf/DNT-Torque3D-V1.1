...
namespace DNT_FPS_Demo_Game_Dll.Scripts.Server
    ...
    public partial class Main : TorqueScriptTemplate
        ...
        public void Kick(coGameConnection client)
            {
            MessageAll("MsgAdminForce", console.ColorEncode(@"\c2The Admin has kicked %1."), client["playerName"]);
            if (!client.isAIControlled())
                console.Call_Classname("BanList", "add", new[] {client["guid"], client.getAddress(), sGlobal["$Pref::Server::KickBanTime"]});
