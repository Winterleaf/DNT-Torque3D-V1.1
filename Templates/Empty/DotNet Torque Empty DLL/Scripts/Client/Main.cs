...
namespace DNT_Empty_DLL.Scripts.Client
    {
    public class Main : TorqueScriptTemplate
        ...
        [Torque_Decorations.TorqueCallBack("", "", "Quit", "", 0, 0, false)]
        public void doQuit()
            {
            m_ts.Stop();
            }
        ...
        public void loaddoquit()
            {
            m_ts.DoScriptInjection(ScriptType.Client, 0, 0);
            }
        }
    }