...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoGuiMeshRoadEditorCtrl : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coGuiMeshRoadEditorCtrl(value as string);
                }
    ...
    public class coGuiMeshRoadEditorCtrl : coEditTSCtrl
        ...
        internal coGuiMeshRoadEditorCtrl(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiMeshRoadEditorCtrl(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiMeshRoadEditorCtrl(int simobjectid) : base(simobjectid)
            {
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coGuiMeshRoadEditorCtrl ts, string simobjectid)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiMeshRoadEditorCtrl(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiMeshRoadEditorCtrl(int ts)
            {
            return new coGuiMeshRoadEditorCtrl(ts);
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiMeshRoadEditorCtrl(uint ts)
            {
            return new coGuiMeshRoadEditorCtrl(ts);
            }
