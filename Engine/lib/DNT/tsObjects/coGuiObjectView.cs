...
public coGuiObjectView(string simobjectid) : base(simobjectid){ }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="simobjectid"></param>
public coGuiObjectView(uint simobjectid): base(simobjectid){ }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="simobjectid"></param>
public coGuiObjectView(int simobjectid): base(simobjectid){ }
...
public ColorF lightAmbient
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".lightAmbient").AsColorF();
          }
       set
          {
...
public Point3F lightDirection
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".lightDirection").AsPoint3F();
          }
       set
          {
