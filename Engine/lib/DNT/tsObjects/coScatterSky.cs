...
namespace WinterLeaf.tsObjects
    ...
    public class coScatterSky : coSceneObject
        ...
        internal coScatterSky(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coScatterSky(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coScatterSky(int simobjectid) : base(simobjectid)
            {
            }
