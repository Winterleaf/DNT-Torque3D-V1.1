...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoVehicleBlocker : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coVehicleBlocker(value as string);
                }
...
public coVehicleBlocker(int simobjectid): base(simobjectid){ }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coVehicleBlocker ts, string simobjectid)
            {
  ...
  /// <summary>
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coVehicleBlocker(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coVehicleBlocker(int ts)
            {
            return new coVehicleBlocker(ts);
            }
...
public Point3F dimensions
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".dimensions").AsPoint3F();
          }
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".dimensions", value.AsString());
          }
       }
}}
