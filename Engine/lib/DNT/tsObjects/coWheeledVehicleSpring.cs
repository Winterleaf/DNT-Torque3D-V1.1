...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoWheeledVehicleSpring : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coWheeledVehicleSpring(value as string);
                }
    ...
    public class coWheeledVehicleSpring : coSimDataBlock
        ...
        internal coWheeledVehicleSpring(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coWheeledVehicleSpring(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coWheeledVehicleSpring(int simobjectid) : base(simobjectid)
            {
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coWheeledVehicleSpring ts, string simobjectid)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coWheeledVehicleSpring(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coWheeledVehicleSpring(int ts)
            {
            return new coWheeledVehicleSpring(ts);
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coWheeledVehicleSpring(uint ts)
            {
            return new coWheeledVehicleSpring(ts);
            }
        }
