...
namespace WinterLeaf.tsObjects
    ...
    public class coDebrisData : coGameBaseData
        ...
        internal coDebrisData(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coDebrisData(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coDebrisData(int simobjectid) : base(simobjectid)
            {
            }
