...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoFileStreamObject : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coFileStreamObject(value as string);
                }
    ...
    public class coFileStreamObject : coStreamObject
        ...
        internal coFileStreamObject(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coFileStreamObject(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coFileStreamObject(int simobjectid) : base(simobjectid)
            {
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coFileStreamObject ts, string simobjectid)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coFileStreamObject(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coFileStreamObject(int ts)
            {
            return new coFileStreamObject(ts);
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coFileStreamObject(uint ts)
            {
            return new coFileStreamObject(ts);
            }
