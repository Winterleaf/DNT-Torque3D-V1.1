...
public coGuiShapeEdPreview(string simobjectid) : base(simobjectid){ }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="simobjectid"></param>
public coGuiShapeEdPreview(uint simobjectid): base(simobjectid){ }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="simobjectid"></param>
public coGuiShapeEdPreview(int simobjectid): base(simobjectid){ }
...
public Point2I gridDimension
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".gridDimension").AsPoint2I();
          }
       set
          {
...
public ColorI sunAmbient
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".sunAmbient").AsColorI();
          }
       set
          {
...
public ColorI sunDiffuse
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".sunDiffuse").AsColorI();
          }
       set
          {
