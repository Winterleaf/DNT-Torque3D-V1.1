...
namespace WinterLeaf.tsObjects
    ...
    public class coTSStatic : coSceneObject
        ...
        public TypeTSMeshType collisionType
            {
            get { return (TypeTSMeshType) Enum.Parse(typeof (TypeTSMeshType), dnTorque.self.GetVar(_mSimObjectId + ".collisionType").Replace(" ", "zz_zz")); }
            set { dnTorque.self.SetVar(_mSimObjectId + ".collisionType", value.ToString().Replace("zz_zz", " ")); }
            }
        ...
        public TypeTSMeshType decalType
            {
            get { return (TypeTSMeshType) Enum.Parse(typeof (TypeTSMeshType), dnTorque.self.GetVar(_mSimObjectId + ".decalType").Replace(" ", "zz_zz")); }
            set { dnTorque.self.SetVar(_mSimObjectId + ".decalType", value.ToString().Replace("zz_zz", " ")); }
            }
