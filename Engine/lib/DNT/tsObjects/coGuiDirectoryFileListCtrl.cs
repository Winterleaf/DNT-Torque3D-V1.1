...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoGuiDirectoryFileListCtrl : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coGuiDirectoryFileListCtrl(value as string);
                }
    ...
    public class coGuiDirectoryFileListCtrl : coGuiListBoxCtrl
        ...
        internal coGuiDirectoryFileListCtrl(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiDirectoryFileListCtrl(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiDirectoryFileListCtrl(int simobjectid) : base(simobjectid)
            {
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coGuiDirectoryFileListCtrl ts, string simobjectid)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiDirectoryFileListCtrl(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiDirectoryFileListCtrl(int ts)
            {
            return new coGuiDirectoryFileListCtrl(ts);
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiDirectoryFileListCtrl(uint ts)
            {
            return new coGuiDirectoryFileListCtrl(ts);
            }
