...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoGuiContainer : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coGuiContainer(value as string);
                }
    ...
    public class coGuiContainer : coGuiControl
        ...
        internal coGuiContainer(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiContainer(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiContainer(int simobjectid) : base(simobjectid)
            {
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coGuiContainer ts, string simobjectid)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiContainer(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiContainer(int ts)
            {
            return new coGuiContainer(ts);
            }
