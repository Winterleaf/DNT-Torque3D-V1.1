...
namespace WinterLeaf.tsObjects
    ...
    /// 
    /// </summary>
    internal class tsObjectConvertercoGuiSwatchButtonCtrl : TypeConverter
        {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            ...
            if (value is string)
                {
                return new coGuiSwatchButtonCtrl(value as string);
                }
    ...
    public class coGuiSwatchButtonCtrl : coGuiButtonBaseCtrl
        ...
        internal coGuiSwatchButtonCtrl(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiSwatchButtonCtrl(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coGuiSwatchButtonCtrl(int simobjectid) : base(simobjectid)
            {
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static bool operator ==(coGuiSwatchButtonCtrl ts, string simobjectid)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator string(coGuiSwatchButtonCtrl ts)
            {
            if (object.ReferenceEquals(ts, null))
                return "0";
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiSwatchButtonCtrl(string ts)
            {
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator int(coGuiSwatchButtonCtrl ts)
            {
            if (object.ReferenceEquals(ts, null))
                return 0;
            int i;
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator coGuiSwatchButtonCtrl(int ts)
            {
            return new coGuiSwatchButtonCtrl(ts);
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator uint(coGuiSwatchButtonCtrl ts)
            {
            if (object.ReferenceEquals(ts, null))
                return 0;
            uint i;
        ...
        public void setColor(string newColor)
            {
            TorqueScriptTemplate.m_ts.fnGuiSwatchButtonCtrl_setColor(_mSimObjectId, newColor);
            }
        }
    }