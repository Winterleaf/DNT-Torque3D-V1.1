...
namespace WinterLeaf.tsObjects
    ...
    public class coGuiMLTextCtrl : coGuiControl
        ...
        public bool allowColorChars
            {
            get { return dnTorque.self.GetVar(_mSimObjectId + ".allowColorChars").AsBool(); }
            set { dnTorque.self.SetVar(_mSimObjectId + ".allowColorChars", value.AsString()); }
            }
        ...
        public int maxChars
            {
            get { return dnTorque.self.GetVar(_mSimObjectId + ".maxChars").AsInt(); }
            set { dnTorque.self.SetVar(_mSimObjectId + ".maxChars", value.AsString()); }
            }
        ...
        public bool useURLMouseCursor
            {
            get { return dnTorque.self.GetVar(_mSimObjectId + ".useURLMouseCursor").AsBool(); }
            set { dnTorque.self.SetVar(_mSimObjectId + ".useURLMouseCursor", value.AsString()); }
            }
