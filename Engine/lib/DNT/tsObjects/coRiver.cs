...
namespace WinterLeaf.tsObjects
    ...
    public class coRiver : coWaterObject
        ...
        internal coRiver(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coRiver(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coRiver(int simobjectid) : base(simobjectid)
            {
            }
