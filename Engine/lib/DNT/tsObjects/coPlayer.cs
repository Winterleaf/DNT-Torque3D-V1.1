...
namespace WinterLeaf.tsObjects
    ...
    public class coPlayer : coShapeBase
        ...
        internal coPlayer(string simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coPlayer(uint simobjectid) : base(simobjectid)
            {
            }
        ...
        /// </summary>
        /// <param name="simobjectid"></param>
        internal coPlayer(int simobjectid) : base(simobjectid)
            {
            }
